...
const DictCtx = createContext<Dict>({} as Dict);
  ...
  return (
    <section className="py-24 bg-panel">
      ...
      <div className="grid grid-cols-2 gap-2 px-4">
        {REVIEW_SRCS.slice(0, visibleCount).map((src) => (
...
function InfoSection() {
  ...
  const MAP_SRC = "https://maps.google.com/maps?q=경상북도+포항시+남구+대이로+159번길+12-8&output=embed&hl=ko";
...
export function DansoPage({ dict }: { dict: Dict }) {
